      ...
      <div className='my-0 mx-auto flex h-full md:h-3/4 justify-center items-center '>
        <div className='w-full md:w-3/4 lg:w-2/5 p-4'>
          ...
          <p className="text-xl md:text-3xl text-justify text-white">
            Sou um desenvolvedor full stack apaixonado por tecnologia e inovação. Sou uma pessoa proativa, 
            esforçada e organizada. Com habilidades sólidas de trabalho em equipe, reconheço a importância 
            ...
            Universidade Federal do Ceará, estou empenhado em aprender e crescer. Minha experiência inclui trabalhar 
            em projetos diversos e utilizar tecnologias como React, React Native, Java, Node, Django e bancos de dados 
            como PostgreSQL, MySQL e MongoDB. Além disso, estou familiarizado com Docker e Linux. 
            Estou entusiasmado para enfrentar desafios e colaborar em projetos que contribuam para meu 
