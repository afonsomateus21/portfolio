export function About() {
  return (
    <section className='md:w-9/12 my-0 mx-auto p-8 h-screen'>
      <h1 className="md:text-6xl text-3xl text-white">Prazer, me chamo Afonso Mateus.</h1>
      <p className="mt-4 text-lg text-justify text-blue-50">
