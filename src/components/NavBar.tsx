...
export function NavBar() {
  ...
  return (
    <header className='shadow-md w-full fixed top-0 left-0 bg-red-500'>
      <div className='lg:w-9/12 lg:my-0 lg:mx-auto md:flex items-center justify-between  py-4 md:px-10 px-7'>
        ...
        <ul className={`bg-red-500 md:flex md:items-center md:pb-0 pb-12 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ':'top-[-490px]'}`}>
          {
            Links.map((link)=>(
